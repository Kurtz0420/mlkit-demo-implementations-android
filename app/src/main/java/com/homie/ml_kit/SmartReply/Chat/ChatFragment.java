package com.homie.ml_kit.SmartReply.Chat;
...
import com.homie.ml_kit.SmartReply.Models.Message;
...
//                imm.hideSoftInputFromWindow(view.getWindowToken(), 0);
        ...
        mViewModel.getSuggestions().observe(getViewLifecycleOwner(),new Observer<List<SmartReplySuggestion>>(){
            @Override
            public void onChanged(@Nullable List<SmartReplySuggestion> smartReplySuggestions) {

                mChipAdapter.setSuggestions(smartReplySuggestions);
